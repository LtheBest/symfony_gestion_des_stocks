...
class __TwigTemplate_86f8b9ef29969049a37f57f9929c9703 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return array (  70 => 6,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    {# <h3>{{hello}}</h3>
    <p style=\"color:{{color}};\">Je suis {{color}}</p> #}

    {# <p>{{number}}</p> #}
{% endblock %}
", "default/index.html.twig", "/Applications/MAMP/htdocs/dev/templates/default/index.html.twig");
    }
}
